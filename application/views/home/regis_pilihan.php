...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset_login/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">
<!--===============================================================================================-->
				...
				<form class="login100-form validate-form">
					<span class="login100-form-title p-b-55">
						...
						<div class="container-login100-form-btn p-t-25">
							<a class="login100-form-btn" style="background-color: #5F9EA0;"  href="<?php echo base_url('index.php/Welcome/registrasi_pencari'); ?>">
								Pencari Kos
							</a>
						</div>

						<div class="container-login100-form-btn p-t-25">
							<a class="login100-form-btn" style="background-color: #5F9EA0;" href="<?php echo base_url('index.php/Welcome/registrasi_pemilik'); ?>">
								Pemilik Kos
							</a>
						</div>

						<div class="container-login100-form-btn p-t-25">
							<a class="login100-form-btn" style="background-color: #5F9EA0;" href="<?php echo base_url('index.php/Welcome/registrasi_admin'); ?>">
								Admin Kos
							</a>
						</div>
