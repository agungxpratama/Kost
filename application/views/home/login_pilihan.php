					...
					<form class="login100-form validate-form">
						<span class="login100-form-title p-b-55">
							...
							<div class="container-login100-form-btn p-t-25">
								<a class="login100-form-btn" style="background-color: #5F9EA0;"  href="<?php echo base_url('index.php/Welcome/login_pencari'); ?>">
									Pencari Kos
								</a>
							</div>

							<div class="container-login100-form-btn p-t-25">
								<a class="login100-form-btn" style="background-color: #5F9EA0;" href="<?php echo base_url('index.php/Welcome/login_pemilik'); ?>">
									Pemilik Kos
								</a>
							</div>

							<div class="container-login100-form-btn p-t-25">
								<a class="login100-form-btn" style="background-color: #5F9EA0;" href="<?php echo base_url('index.php/Welcome/login_admin'); ?>">
									Admin Kos
								</a>
							</div>
