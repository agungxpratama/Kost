  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #5F9EA0;">
      ...
      <li class="nav-item active">
        <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('index.php/admin/data_penghuni') ?>">
     ...
     <li class="nav-item active">
        <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('index.php/admin/data_kos') ?>">
          <i class="fas fa-fw fa-folder"></i>
          <span>Data Kos</span>
        </a>
      </li>
       ...
       <li class="nav-item active">
        <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('index.php/admin/data_pemilik') ?>">
          <i class="fas fa-fw fa-folder"></i>
       ...
       <li class="nav-item active">
        <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('index.php/admin/transaksi') ?>">
          <i class="fas fa-fw fa-folder"></i>
          <span>Transaksi</span>
        </a>
      </li>
      ...
      <li class="nav-item active">
        <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('index.php/admin/artikel') ?>">
          <i class="fas fa-fw fa-folder"></i>
          <span>Artikel</span>
        </a>
      </li>
